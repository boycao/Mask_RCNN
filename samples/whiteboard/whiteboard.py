...
class WhiteboardConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Background + smiling face
...
class WhiteboardDataset(utils.Dataset):
    ...
    def load_whiteboard(self, dataset_dir, subset):
        ...
        self.add_class("whiteboard", 1, "whiteboard")
    ...
    def image_reference(self, image_id):
        """returns a string that identifies the image for debugging purposes
        Return:
